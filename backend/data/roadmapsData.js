    ...
    steps: [
      {
        ...
        description: 'Master a programming language, understand algorithms, and learn data structures for efficient code.',
        resources: [
      ...
      },
      {
        ...
        description: 'Learn relational databases, NoSQL databases, database modeling, indexing, and optimization.',
        resources: [
      ...
      },
      {
        ...
        description: 'Build RESTful APIs, GraphQL APIs, authentication systems, and microservices architecture.',
        resources: [
