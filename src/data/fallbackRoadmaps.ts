import { RoadmapStep } from '../lib/supabase';
...
export const fallbackRoadmaps: FallbackRoadmap[] = [
  {
    ...
    steps: [
      {
        ...
        description: 'Master React, TypeScript, state management, and modern CSS frameworks like Tailwind CSS.',
        resources: [
          'https://react.dev/learn',
      ...
      },
      {
        ...
        description: 'Learn Node.js, Express, RESTful APIs, authentication, and database design with PostgreSQL or MongoDB.',
        resources: [
...
export function getFallbackRoadmap(role: string): FallbackRoadmap | null {
